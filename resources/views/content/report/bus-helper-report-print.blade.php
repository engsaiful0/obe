...
<html>
<head>
    <title>Bus Helper Report - Print</title>
    <style>
        @media print {
...
<body>
    ...
    <h4>Bus Helper Report</h4>
    <div class="summary">
        <p><strong>Total Bus Helpers:</strong> {{ $totalCount }}</p>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="11" class="text-center">No bus helpers found.</td>
            </tr>
            @endforelse
        </tbody>
        <tfoot>
