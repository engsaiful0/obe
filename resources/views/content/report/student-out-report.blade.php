...
@section('title', 'Student OUT Report')
  ...
  $(function () {
    ...
    $('#from_date, #to_date').on('change', function() {
      if ($('#from_date').val() && $('#to_date').val()) {
        $('#student-out-report-form').submit();
      }
    });
  });
</script>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">
            <i class="ti ti-users me-2"></i>Student OUT Report
        </h5>
        <div class="no-print">
            <a href="{{ route('student-out-report.print', request()->query()) }}" class="btn btn-sm btn-outline-primary" target="_blank">
                <i class="ti ti-printer me-1"></i>Print
            </a>
            <a href="{{ route('student-out-report.pdf', request()->query()) }}" class="btn btn-sm btn-outline-danger" target="_blank">
                <i class="ti ti-file-pdf me-1"></i>Export PDF
            </a>
            <a href="{{ route('student-out-report.excel', request()->query()) }}" class="btn btn-sm btn-outline-success">
    ...
    <div class="card-body">
        <!-- Filter Form -->
        <form id="student-out-report-form" method="GET" action="{{ route('student-out-report') }}" class="mb-4 no-print">
            <div class="row g-3">
                <div class="col-md-4">
