...
@section('title', 'Add Bus Requisition')

@section('page-script')
<script>
    window.busRequisitionUrls = {
        store: '{{ route('app-bus-requisitions.store') }}',
        index: '{{ route('app-bus-requisitions') }}'
    };
</script>
<script src="{{ asset('assets/js/bus-requisition-add.js') }}?v={{ time() }}"></script>
@endsection
...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">Add New Bus Requisition</h5>
            <a href="{{ route('app-bus-requisitions') }}" class="btn btn-label-secondary">
                <i class="ti ti-arrow-left me-1"></i> Back to List
            </a>
        </div>
        <div class="card-body">
            <form id="bus-requisition-form" method="POST" action="{{ route('app-bus-requisitions.store') }}">
                @csrf
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <textarea id="purpose" class="form-control @error('purpose') is-invalid @enderror" 
                                      ...
                                      aria-label="Enter Purpose" aria-describedby="purpose2" required>{{ old('purpose') }}</textarea>
                        </div>
                        @error('purpose')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="date" id="required_bus_date" class="form-control @error('required_bus_date') is-invalid @enderror" 
                                   name="required_bus_date" value="{{ old('required_bus_date') }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="time" id="required_time" class="form-control @error('required_time') is-invalid @enderror" 
                                   name="required_time" value="{{ old('required_time') }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="number" id="number_of_buses" class="form-control @error('number_of_buses') is-invalid @enderror" 
                                   ...
                                   value="{{ old('number_of_buses') }}" aria-label="Enter Number of Buses" 
                                   aria-describedby="number_of_buses2" required />
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="number" id="total_passengers" class="form-control @error('total_passengers') is-invalid @enderror" 
                                   ...
                                   value="{{ old('total_passengers') }}" aria-label="Enter Total Passengers" 
                                   aria-describedby="total_passengers2" required />
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="requisition_sender_name" class="form-control @error('requisition_sender_name') is-invalid @enderror" 
                                   ...
                                   value="{{ old('requisition_sender_name') }}" aria-label="Enter Sender Name" 
                                   aria-describedby="requisition_sender_name2" required />
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="mobile_number" class="form-control @error('mobile_number') is-invalid @enderror" 
                                   ...
                                   value="{{ old('mobile_number') }}" aria-label="Enter Mobile Number" 
                                   aria-describedby="mobile_number2" required />
                        </div>
                        @error('mobile_number')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="email" id="email_address" class="form-control @error('email_address') is-invalid @enderror" 
                                   ...
                                   value="{{ old('email_address') }}" aria-label="Enter Email Address" 
                                   aria-describedby="email_address2" required />
                        </div>
                        @error('email_address')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
