        ...
        <table class="table table-striped table-hover table-bordered busesTable-{{ $tabPrefix }}" id="busesTable-{{ $tabPrefix }}">
            ...
            <tbody>
                ...
                <tr data-bus-id="{{ $bus->id }}" data-sub-type="{{ $bus->busSubType->sub_type_name ?? '' }}" data-tab="{{ $tabPrefix }}">
                    ...
                    @endif
                    <td>
                        <input  class="form-control form-control-sm distance-input" readonly placeholder="TN" type="number"  name="trips[{{ $uniqueIndex }}][trip_number]" value="{{ $busTripNumbers[$bus->id] ?? '' }}">
                    </td>
                    <td>
                        <button type="button" 
