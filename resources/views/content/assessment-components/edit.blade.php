...
@section('title', __('Edit assessment component'))

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">{{ __('Edit assessment component') }}</h5>
    </div>
    <div class="card-body">
        <form method="POST"
            action="{{ route('assessment-components.update', $component) }}"
            id="ac-edit-form"
            ...
            @include('content.assessment-components._form')
