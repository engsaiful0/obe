...
@section('title', __('Add CLO–PO mapping'))

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">{{ __('New CLO–PO / PLO mapping') }}</h5>
    </div>
    <div class="card-body">
        <form method="POST"
            action="{{ route('clo-po-mappings.store') }}"
            id="cpm-create-form"
            ...
            @include('content.clo-po-mappings._form', ['mapping' => null])
