            ...
            <form class="add-new-record pt-0 row g-2" id="form-add-new-record" onsubmit="return false">
                <div class="col-sm-12">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" id="status_name" class="form-control dt-full-name" name="status_name"
                            placeholder="Enter Status Name" aria-label="Enter Status Name"
                            aria-describedby="status_name2" />
                    </div>
                </div>
                <div class="col-sm-12">
