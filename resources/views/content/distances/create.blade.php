...
<div class="card">
    <div class="card-header">
        <h5 class="card-title">Add New Distance</h5>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <form id="distanceForm" action="{{ route('distances.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-12">
                    ...
                    <input type="text" name="distance_name" id="distance_name" class="form-control @error('distance_name') is-invalid @enderror"
                           value="{{ old('distance_name') }}" placeholder="Enter distance name">
                    @error('distance_name')
                ...
                <div class="col-12">
                    <div class="d-flex gap-2">
                        <button type="submit" id="submitBtn" class="btn btn-primary">
                            <span id="submitText">
                                <i class="ti ti-check me-1"></i>Create Distance
                            </span>
    ...
    $('#distanceForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                toastr.success('Distance created successfully!');
                setTimeout(function() {
            ...
            error: function(xhr) {
                if (xhr.status === 422) {
                    ...
                    toastr.error('An error occurred while creating the distance.');
                }
            },
            complete: function() {
                // Hide spinner
