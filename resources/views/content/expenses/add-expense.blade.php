...
<script src="{{ asset('assets/js/expense-add.js') }}?v={{ time() }}"></script>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="expense-form" method="POST" action="{{ route('expenses.store') }}" data-redirect-url="{{ route('expenses.index') }}">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label" for="memo_no">Memo No*</label>
                                <input placeholder="Enter Memo No" type="text" class="form-control" id="memo_no" name="memo_no" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="bill_no">Bill No*</label>
                                <input placeholder="Enter Bill No" type="text" class="form-control" id="bill_no" name="bill_no" required>
                            </div>
                            <!-- Expense Head -->
                            <div class="col-md-6">
                            ...
                            <!-- Bus Sub Type -->
                            <div class="col-md-6" id="bus_sub_type_wrapper">
                            ...
                            <!-- Supplier -->
                            <div class="col-md-6" id="supplier_id_wrapper">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" id="remarks" name="remarks" rows="3" placeholder="Enter expense remarks"></textarea>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
