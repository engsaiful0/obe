...
use App\Exports\BusHelperExport; // Reusing existing export class or should create new one? Assuming reuse for now.
...
class HelperListController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'success' => true,
                'html' => view('content.report.helper-list-table', compact('busHelpers', 'totalCount', 'totalSalary', 'avgSalary'))->render(),
        ...
        return view('content.report.helper-list', compact(
            'busHelpers',
            'genders',
            'statuses',
            'employeeTypes',
    ...
    public function pdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('content.report.helper-list-pdf', compact(
            'busHelpers',
            'totalCount',
            'totalSalary',
            'avgSalary',
        ...
        return $pdf->stream('helper-list-' . date('Y-m-d_H-i-s') . '.pdf');
    }
    ...
    public function print(Request $request)
    {
        ...
        return view('content.report.helper-list-print', compact(
            'busHelpers',
            'totalCount',
            'totalSalary',
            'avgSalary',
    ...
    public function excel(Request $request)
    {
        ...
        return Excel::download(new BusHelperExport($busHelpers), 'helper-list-' . date('Y-m-d_H-i-s') . '.xlsx');
    }
